...
export function PipelineStrip({
  ...
  return (
    <div className="rounded-lg bg-panel px-6 py-7 sm:px-8 sm:py-8 overflow-x-auto">
        ...
        {stages.map((stage, i) => (
          <div key={stage.index} className="flex items-stretch flex-1">
            <div className="flex flex-col flex-1 min-w-[140px]">
              ...
              <span className="font-display text-2xl text-white mt-2 tabular-nums">{stage.count}</span>
              <span className="font-body text-sm text-white/90 mt-3">{stage.label}</span>
